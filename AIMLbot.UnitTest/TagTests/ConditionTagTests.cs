...
namespace AIMLbot.UnitTest.TagTests
{
    ...
    public class ConditionTagTests
    {
        ...
        {
            _request = new Request("test multi condition", _user);
        ...
        {
            _request = new Request("test block recursive call", _user);
            _result = _chatBot.Chat(_request);
        ...
        {
            _request = new Request("TEST SET AND CONDITION", _user);
            _result = _chatBot.Chat(_request);
        ...
        {
            _request = new Request("test block condition", _user);
            _result = _chatBot.Chat(_request);
            Assert.AreEqual("Test passed.", _result.RawOutput);
        }
        ...
        {
            _request = new Request("test single condition", _user);
